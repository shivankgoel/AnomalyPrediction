...
print('reading_whitened_data...')
'''
Read the whitened data
'''
retailDFP = pd.read_csv(CONSTANTS['RETAILPRICES_WHITENED'], header=None, index_col=0)
mandiDFP = pd.read_csv(CONSTANTS['MANDIPRICES_WHITENED'], header=None, index_col=0)
mandiDFA = pd.read_csv(CONSTANTS['MANDIARRIVALS_WHITENED'], header=None, index_col=0)
